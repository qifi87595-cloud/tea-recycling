    ...
    <>
      ...
      <div className="fixed right-4 top-1/2 -translate-y-1/2 z-40 flex flex-col items-center group">
        <button
          ...
          className="relative w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#07C160] hover:bg-[#06AD56] text-white shadow-lg hover:shadow-xl hover:scale-110 active:scale-90 flex items-center justify-center animate-[breathe-scale_2s_ease-in-out_infinite] hover:animate-none transition-[transform,background-color,box-shadow] duration-300"
          aria-label="微信咨询"
        >
        ...
        >
          ...
          >
            ...
            <div className="text-center">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#07C160] flex items-center justify-center">
